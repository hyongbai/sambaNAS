...
import yourbay.me.testsamba.samba.httpd.CyberSmbStreamer;
    ...
    public int open() {
        ...
        if (binds != null) {
            ...
            for (int i = 0; i < binds.length; i++) {
                ...
                Log.d(CyberSmbStreamer.TAG, "HTTPServerList 1  open  bindAddresses[n]  " + bindAddresses[i]);
            }
        } else {
            ...
            for (int n = 0; n < nHostAddrs; n++) {
                ...
                Log.d(CyberSmbStreamer.TAG, "HTTPServerList 2 open  bindAddresses[n]  " + bindAddresses[n]);
            }

//            bindAddresses = new String[]{"127.0.0.1"};
        }
        int j = 0;
